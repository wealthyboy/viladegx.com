<template>
    <div>
        <div v-if="!loading && carts.length" class="row">
                    ...
                    <form action="/update/cart" method="" class="cart-form">
                        ...
                        <div class="cart-product-table-wrap ">
                            <div
                                v-for="cart in carts"
                                :key="cart.id"
                                class="row cart-rows raised bg--light mb-3 pt-4 pb-4"
                            >
                                <div class="col-md-3 col-6">
                                    <div class="cart-image">
                                        <img
                                            :src="
                                                cart.product_variation.image_m
                                            "
                                            alt=""
                                        />
                                    </div>
                                ...
                                <div class="col-md-7 col-6">
                                    ...
                                    >
                                        ...
                                        <div
                                            class="product-price-amount retail"
                                        >
                                            <span class="retail-title text-gold"
                                                >PRICE</span
                                            >
                                            <span
                                                class="product--price retail-price text-gold"
                                                >{{ meta.currency
                                                }}{{
                                                    cart.product_variation
                                                        .price | priceFormat
                                ...
                                <div class="col-md-2">
                                    <div class="pt-2 pb-4 form-group">
                                        ...
                                        <div
                                            id="quantity_1234"
                                            class="product-quantity select-custom"
                                        >
                                            <select
                                                @change="
                                                    updateCartQty(
                                    ...
                                    <div class="">
                                        <a
                                            href="#"
                                            @click.prevent="
                                                removeFromCart($event, cart.id)
                                            "
                                            class=" text-danger btn-transparent bold"
                                        >
            ...
            <div class="col-md-4 ">
                <div
                    class="cart-collateralse  bg--light  border pb-3 pt-3 pl-3 pt-3 pr-3 raised"
                >
