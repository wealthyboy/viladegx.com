                ...
                <div class="col-md-5 product-single-details mt-3 mt-sm-5  mt-xs-5">
                    ...
                    <div class="">
                        ...
                        <div class="row ml-1 mb-2 mt-2 no-gutters">
                            ...
                            <div class="col-8">
                                <button @click.prevent="addToCart"  :class="{ 'disabled': canNotAddToCart }"  type="button" name="add-to-cart" value="add_to_cart" class="l-f1  pt-4 pb-4  btn btn--primary  add-to-cart btn-lg btn-block">
                                    {{ cartText }}
