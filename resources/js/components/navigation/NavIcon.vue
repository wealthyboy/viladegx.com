    ...
    <div class="header-right w-lg-max ml-0 ml-lg-auto">
        ...
        <div v-if="$root.loggedIn" class="header-dropdown ml-4">
            ...
            <div class="header-menu ">
                <ul>  
                    <li><a class="color--primary" href="/fashion/account"><i class="fas fa-user left mr-2"></i>Account</a></li>
                    <li><a class="color--primary" href="/fashion/orders"><i class="fas fa-sign-out-alt left mr-1"></i> Orders</a></li>
                    <li>
                        <a class="color--primary" href="/fashion/logout"
            ...
            <a href="/fashion/wishlist" class="dropdown-toggle dropdown-arrow " role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
        ...
        <div class="dropdown cart-dropdown">
            <a href="#" class="dropdown-toggle dropdown-arrow " role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                ...
                <span v-if="cartItemCount >=1 " class="cart-count badge-circle">{{ cartItemCount }}</span>
            </a>
