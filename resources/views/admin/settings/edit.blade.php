                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <option  value="">--Type--</option>
                                    <option   value="fashion" {{ null !== $setting && $setting->type == "fashion" ? 'selected' : '' }}>Fashion</option>
                                    <option  value="conceige_service"  {{ null !== $setting && $setting->type == "conceige_service"  ? 'selected' : '' }}>Conceige Service</option>
                                </select>
                            </div>
